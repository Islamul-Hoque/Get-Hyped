...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 w-full flex items-center justify-between px-10 py-4 z-50 bg-[#FAF4EC]">
      {/* Logo */}
      ...
      {/* Nav Link */}
      <div className="flex bg-white rounded-[0.7rem] px-1.5 py-1 border border-gray-100">
        {navLinks.map((link) => (
      ...
      >
        ...
        <div className="flex items-center gap-2 pl-3 pr-1">
          <motion.span className="text-black font-bold whitespace-nowrap text-sm flex items-center gap-2"
            variants={{
              hover: {
                rotate: -1,
