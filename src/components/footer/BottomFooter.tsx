...
const socials = [
    ...
    { label: "Instagram", href: "https://www.instagram.com/gethyped.nl/", icon: <FaInstagram size={16} /> },
    { label: "YouTube", href: "https://www.youtube.com/@gethypednl", icon: <FaYoutube size={16} /> },
];
    ...
    return (
        <div className="relative w-full">
            ...
            <div className="absolute px-4 inset-0 w-full h-full pointer-events-none -z-10">
                <svg
                    viewBox="0 0 1860 386" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            {/* Footer Badge */}
            <motion.div
                className="absolute hidden md:block top-0 right-[11%] -translate-y-1/2 z-30"
